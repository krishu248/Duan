	...
	<div class="container">
		<div class="row">
		    ...
		    <div class="myfaceshop-logo">
					<a href="index.jsp" title="myFace Shop">
						<h1 class="logo-text">
							<img class="" src="assets/images/logo/logo.png" alt="myface" style="height: 80px;width: 80px;">	
						</h1>
					</a>
				</div>
		        ...
		        <li class="dropdown account-block">
		          <a href="#" class="dropdown-toggle account-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
		          	<div class="account-img">
		          		<img src="assets/images/upload/user/user.jpg" class="acc-image img-circle" alt="myface">
		          	</div>
		          	<div class="account-label">
                  <span class="account-label-1" data-original-title="" title="">Đặng Hữu Biên</span>
              	</div>
		          </a>
		          <ul class="dropdown-menu account-dropdown">
		            <li><a href="login.jsp">Đăng nhập/Đăng ký</a></li>
		            <li><a href="#">blacksnow</a></li>
		            <li><a href="#">blacksnow</a></li>
		          </ul>
