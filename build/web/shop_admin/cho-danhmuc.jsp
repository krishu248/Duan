...
<section class="content-header" id="content-header">
  <div class="container">
    <div class="row">
      ...
      <ol class="breadcrumb">
        <li><a href="cho-danhmuc.jsp" class="active">Danh mục sản phẩm</a></li>
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="box-header with-border">
          ...
          <a href="cho-tao-danhmuc.jsp" class="btn btn-default pull-right"> + Tạo danh mục sản phẩm mới</a>
        </div>
          ...
          <table class="table table-striped">
            <thead>
              <tr>
                ...
                <th class="col-md-3">Ngành hàng</th>
            ...
            <tbody>
              ...
              <tr>
                <td>169</td>
                <td><a href="2.2-create-category.html" class="cate-name">Tai Nghe Bluetooth</a></td>
                <td>Thiết bị số</td>
              ...
              <tr>
                <td>269</td>
                <td><a href="2.2-create-category.html" class="cate-name">Sơ mi nam</a></td>
